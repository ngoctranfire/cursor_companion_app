...
internal fun terminalNotificationType(
    ...
    val isFinishedNow = currentStatus == RunStatus.FINISHED
    val isTerminalNow = isFinishedNow || currentStatus == RunStatus.ERROR
    ...
    return if (persistedMode == AgentMode.PLAN && isFinishedNow) {
        TerminalNotificationType.PLAN_READY
    } else {
        TerminalNotificationType.RUN_TERMINAL
    }
